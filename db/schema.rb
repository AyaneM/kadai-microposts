...
ActiveRecord::Schema.define(version: 20180718231531) do
  ...
  create_table "favorites", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["like_id"], name: "index_favorites_on_like_id", using: :btree
    t.index ["user_id", "like_id"], name: "index_favorites_on_user_id_and_like_id", unique: true, using: :btree
  ...
  add_foreign_key "favorites", "likes"
